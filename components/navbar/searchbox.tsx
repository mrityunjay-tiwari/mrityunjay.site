  ...
  return (
    <>
      <p className="text-muted-foreground text-sm hover:cursor-pointer">
        <Button className="shadow-[inset_0_2px_4px_rgba(0,0,0,0.12)] border-none  rounded-2xl flex items-center bg-transparent font-normal hover:cursor-pointer" variant={'outline'} onClick={() => setOpen(!open)}>
          <SearchIcon /><p className="mr-5">Search</p>
