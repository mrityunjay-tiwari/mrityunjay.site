...
export default function ThanksMessage() {
  return (
    <div
      className={cn(`justify-self-center text-center shadow-[inset_0_2px_4px_rgba(0,0,0,0.12)] dark:shadow-[inset_0_2px_2px_rgba(255,255,255,0.12)] p-3.5 md:p-6 rounded-full flex md:max-w-xl items-center justify-center w-full max-w-[calc(100%-2.5rem)] mx-auto gap-2 my-10 ${sans.className}`)}
    >
