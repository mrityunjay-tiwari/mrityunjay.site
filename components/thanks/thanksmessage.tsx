...
export default function ThanksMessage() {
  return (
    <div
      className={cn(`justify-self-center text-center shadow-[inset_0_2px_4px_rgba(0,0,0,0.12)] dark:shadow-[inset_0_2px_4px_rgba(255,255,255,0.06)] p-6 rounded-xl flex gap-2 my-10 ${sans.className}`)}
    >
