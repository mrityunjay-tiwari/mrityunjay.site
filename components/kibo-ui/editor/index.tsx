...
export const defaultSlashSuggestions: SuggestionOptions<SuggestionItem>["items"] =
  () => [
    ...
    // {
    //   title: "Image",
    //   description: "Insert image with optional caption",
    //   searchTerms: ["image", "photo", "picture"],
    //   icon: ImageIcon,
    //   command: ({editor, range}) => {
    //     const url = window.prompt("Enter image URL");
        ...
        <CommandItem
          ...
          onSelect={() => {
            editor
              .chain()
              .focus()
              .deleteRange(range) // removes "/query"
              .run();
...
export const EditorProvider = ({
  ...
  const defaultExtensions = [
    ...
    // Image.configure({
    //   inline: false,
    //   allowBase64: true, // important for local uploads / paste
    //   HTMLAttributes: {
    ...
    <TooltipProvider>
      <div
        className={cn(
          ...
          "[&_.ProseMirror_h1]:text-3xl [&_.ProseMirror_h1]:font-bold [&_.ProseMirror_h1]:mt-6",
          "[&_.ProseMirror_h2]:text-2xl [&_.ProseMirror_h2]:font-semibold [&_.ProseMirror_h2]:mt-5",
          "[&_.ProseMirror_h3]:text-xl  [&_.ProseMirror_h3]:font-semibold [&_.ProseMirror_h3]:mt-4",
          "[&_.ProseMirror_img]:mx-auto [&_.ProseMirror_img]:my-4",
          "[&_.ProseMirror_img]:rounded-lg",
          "[&_.ProseMirror_img]:max-w-full",
          "[&_.ProseMirror_img]:w-full md:[&_.ProseMirror_img]:w-4/5",

          // "[&_.ProseMirror_figure]:w-full",
          // "[&_.ProseMirror_figcaption]:italic",
          // "[&_.ProseMirror_figcaption]:opacity-70",
          // "[&_.ProseMirror_figcaption:empty]:before:content-[attr(data-placeholder)]",
          // "[&_.ProseMirror_figcaption:empty]:before:opacity-50",
        )}
      >
